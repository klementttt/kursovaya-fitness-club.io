...
urlpatterns = [
    ...
    path('remove_booking_from_cart/<int:booking_id>/', product_views.remove_booking_from_cart, name='remove_booking_from_cart'),
    path('callback-request/', product_views.callback_request, name='callback_request'),  # Добавленный путь
